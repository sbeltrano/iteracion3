...
public class DAORFC10 {
	...
	public ArrayList<RFC10> rfc10Nombre(String fechaInicial, String fechaFinal) throws SQLException
	{
		String sql = String.format("SELECT DISTINCT RES.COMUNIDADID, CO.NOMBRE, CO.ROL, CO.CARNET\n" + 
				...
				"		WHERE RES.COMUNIDADID=CO.COMUNIDADID\n" + 
		...
		ArrayList<RFC10> rfc4 = new ArrayList<>();

		while (rs.next()) {
			System.out.println("entra al next RFC1");

			RFC10 reserva = convertResultSetRFC10Nombre(rs);
	...
	public ArrayList<RFC10> rfc10Carnet(String fechaInicial, String fechaFinal) throws SQLException
	{
		String sql = String.format("SELECT DISTINCT RES.COMUNIDADID, CO.NOMBRE, CO.ROL, CO.CARNET\n" + 
				"		FROM\n" + 
				"		(SELECT r.COMUNIDADID\n" + 
	...
	public ArrayList<RFC10> rfc10Rol(String fechaInicial, String fechaFinal) throws SQLException
	{
		String sql = String.format("SELECT DISTINCT RES.COMUNIDADID, CO.NOMBRE, CO.ROL, CO.CARNET\n" + 
				"		FROM\n" + 
				"		(SELECT r.COMUNIDADID\n" + 
	 ...
	 */
	public RFC10 convertResultSetRFC10Nombre(ResultSet resultSet) throws SQLException {
