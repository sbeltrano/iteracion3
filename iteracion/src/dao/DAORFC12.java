...
public class DAORFC12 {
	...
	public ArrayList<RFC12> rfc12(int year) throws SQLException
	{
	...
	public RFC12 convertResultSetToReservaVivienda(ResultSet resultSet) throws SQLException {
		...
		int carnet = resultSet.getInt("VIVIENDAID");
		int operadorId = resultSet.getInt("VIVIENDAID");
		String nombre = resultSet.getString("VIVIENDAID");;

		rfc4 = new RFC12(carnet,operadorId, nombre);
