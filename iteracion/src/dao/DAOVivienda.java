...
public class DAOVivienda {
	...
	public void deleteVivienda(int id) throws SQLException
	{	
	...
	public int getIdReservaActual(int idVivienda )throws SQLException, Exception
	{
		int idReserva = 0; 

		String sql = String.format( "SELECT RESERVAID FROM %1$s.VIVIENDA WHERE VIVIENDAID = %2$", USUARIO,	idVivienda);
