...
public class RFC9Service {
			...
			public Response getAlojamientosDisponiblesEnRangoFechasApartamentos() {
				
				try {
					
					AlohaTransactionManager tm = new AlohaTransactionManager(getPath());
					
					List<RFC9> rfc4 = tm.rfc9Apartamentos();
			...
			@Consumes({ MediaType.APPLICATION_JSON })
			@Produces({ MediaType.APPLICATION_JSON })
			public Response getAlojamientosDisponiblesEnRangoFechasViviendas() {
			...
			public Response getAlojamientosDisponiblesEnRangoFechasHabitaciones() {
				...
				try {
					...
					List<RFC9> rfc4 = tm.rfc9Habitaciones();
