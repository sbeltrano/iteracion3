...
public class RFC4Service {
			...
			public Response getAlojamientosDisponiblesEnRangoFechasApartamentos(@PathParam("fechaInicial") String fechaInicial, @PathParam("fechaFinal")String fechaFinal) {
				
				try {
					
					AlohaTransactionManager tm = new AlohaTransactionManager(getPath());
					
					List<RFC4> rfc4 = tm.getAlojamientosDisponiblesEnRangoFechasApto(fechaInicial,fechaFinal);
			...
			public Response getAlojamientosDisponiblesEnRangoFechasHabitacion(@PathParam("fechaInicial") String fechaInicial, @PathParam("fechaFinal")String fechaFinal) {
				...
				try {
					...
					List<RFC4> rfc4 = tm.getAlojamientosDisponiblesEnRangoFechasHabitacion(fechaInicial,fechaFinal);
			...
			public Response getAlojamientosDisponiblesEnRangoFechasVivienda(@PathParam("fechaInicial") String fechaInicial, @PathParam("fechaFinal")String fechaFinal) {
				...
				try {
					...
					List<RFC4> rfc4 = tm.getAlojamientosDisponiblesEnRangoFechasViviendas(fechaInicial,fechaFinal);
